...
const ProductCard = () => {
  return (
    <div className="relative">
      ...
      <div className="opacity-0 hover:opacity-100 absolute inset-0 bg-white bg-opacity-60 flex first:flex-col justify-between p-2 py-3 text-center cursor-pointer transition duration-300 ease-in-out">
